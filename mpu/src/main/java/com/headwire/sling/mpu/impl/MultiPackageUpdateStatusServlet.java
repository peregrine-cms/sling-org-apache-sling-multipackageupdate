...
import static com.headwire.sling.mpu.impl.MultiPackageUpdateServlet.SERVLET_HTML_EXTENSIONS_PROPERTY;
import static com.headwire.sling.mpu.impl.MultiPackageUpdateServlet.SERVLET_JSON_EXTENSIONS_PROPERTY;
...
@Component(service = Servlet.class,
        property = {
            ...
            RESOURCE_TYPES_PROPERTY_PREFIX + "status",
            RESOURCE_TYPES_PROPERTY_PREFIX + "main",
            SERVLET_JSON_EXTENSIONS_PROPERTY,
            SERVLET_HTML_EXTENSIONS_PROPERTY
        })
public final class MultiPackageUpdateStatusServlet extends MultiPackageUpdateServlet {
    ...
    protected MultiPackageUpdateResponse execute(String name) {
        return updater.getStatus(name);
    }

    @Override
    protected int getStatusCode(final MultiPackageUpdateResponse.Code code) {
        return httpMapper.getStatusCode(MultiPackageUpdate.Operation.CURRENT_STATUS, code);
    }
